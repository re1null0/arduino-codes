...
//const int LM35 = A1;// PulseSensor PURPLE WIRE connected to ANALOG PIN 0
const int ledPin = 13;  
const int buttonPin = 2; // The on-board Arduino LED, close to PIN 13.
